...
class Command(BaseCommand):  
    ...
    def add_arguments(self, parser):  
        parser.add_argument("num_patients", type=int, help="Number of patients to create")  
        parser.add_argument(  
    ...
    def handle(self, *args, **options):  
        ...
        for _ in range(num_patients):  
            ...
            self.stdout.write(self.style.SUCCESS(f"Created Patient: {patient.patient_name} ({patient.patient_id})"))  
        ...
        self.stdout.write(  
            self.style.SUCCESS(  
                f"Successfully created {num_patients} patient(s)."  
            )  
        )  
